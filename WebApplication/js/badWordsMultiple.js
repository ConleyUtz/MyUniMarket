...
function badWordsParser(field1,field2,field3, buttonID) {
  ...
  document.getElementById(buttonID).onclick = function(){
    ...
    var check1 = document.getElementById(field1).value;
    var check2 = document.getElementById(field2).value;
    var check3 = document.getElementById(field3).value;
    ...
    while(i < badWordsArr.length){
      ...
      if(check1.includes(badWordsArr[i]) || check2.includes(badWordsArr[i]) || check3.includes(badWordsArr[i])){
